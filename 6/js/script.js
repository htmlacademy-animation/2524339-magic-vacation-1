...
/* harmony import */ var _utils_text_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/text-animation */ "./source/js/utils/text-animation.js");
/* harmony import */ var _utils_story__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/story */ "./source/js/utils/story.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    Object(_utils_story__WEBPACK_IMPORTED_MODULE_2__["removeStorySlideClasses"])();
    ...
    if (window.location.hash === `#story`) {
      this.bodyContainer.classList.add(`story-slide${Object(_utils_story__WEBPACK_IMPORTED_MODULE_2__["getActiveStorySlide"])()}`);
    }
  }
  ...
  createAndRunAnimation(
    ...
    const animation = new _utils_text_animation__WEBPACK_IMPORTED_MODULE_1__["default"](
        selector,
        timer,
        classForActivate,
        properties,
...
/* harmony import */ var _utils_story__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/story */ "./source/js/utils/story.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const setBackgroundAndClass = (slideNumber) => {
    Object(_utils_story__WEBPACK_IMPORTED_MODULE_1__["removeStorySlideClasses"])();
...
/***/ "./source/js/utils/story.js":
/*!**********************************!*\
  !*** ./source/js/utils/story.js ***!
  \**********************************/
/*! exports provided: getActiveStorySlide, removeStorySlideClasses */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getActiveStorySlide", function() { return getActiveStorySlide; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeStorySlideClasses", function() { return removeStorySlideClasses; });
const bodyContainer = document.querySelector(`body`);

const getActiveStorySlide = () =>{
  return parseInt(localStorage.getItem(`activeSlide`), 10) || 1;
};

const removeStorySlideClasses = function () {
...
/***/ "./source/js/utils/text-animation.js":
/*!*******************************************!*\
  !*** ./source/js/utils/text-animation.js ***!
  \*******************************************/
/*! exports provided: default */
